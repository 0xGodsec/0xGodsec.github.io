---
title: "OSINT Investigation Report: Boss Ranzen"
description: "OSINT profile of Boss Ranzen, one of the world's most prolific web defacers with 13,000+ confirmed defacements, linked to D704T and Ghost Exploiter Team, operating primarily against Indonesian and Mexican targets."
date: 2025-08-07 16:49:00 +0000
categories: [OSINT]
tags: [osint, threat-intel, web-defacement, hacktivism, indonesia]
difficulty: Medium
image: /assets/img/osint/boss-ranzen/Ranzen1.png
---
...
![Ranzen1.png](/assets/img/osint/boss-ranzen/Ranzen1.png)
...
- **Consistent Avatar:** Blue power button icon/identicon hash
    ...
    ![Boss Ranzen-6.1.png](/assets/img/osint/boss-ranzen/Boss_Ranzen-6.1.png)
...
- **Social Media**:
    - A network diagram indicates a connection to a Facebook profile "Renzenskyi" and interactions within the "EXECUTOR TEAM CYBER" group, with messages dated November 6, 2023, welcoming "`RanzendollDtd`" to the telegram group.
        ...
        ![Boss Ranzen-8.2.png](/assets/img/osint/boss-ranzen/Boss_Ranzen-8.2.png)
...
- **Tools**:
    - **Mini Shell By Boss Ranzen**: A web-based file management tool observed in a compromised server directory (/var/www/html/v103), allowing file uploads, deletions, and edits. Files like "index.php" and "composer.json" suggest targeting PHP-based web applications.
        ...
        ![FB-2.jpg](/assets/img/osint/boss-ranzen/FB-2.jpg)
...
![image.png](/assets/img/osint/boss-ranzen/image.png)
...
![chart.png](/assets/img/osint/boss-ranzen/chart.png)
...
- **Details**:
    ...
    - A post dated December 30, 2023, listed URLs such as https://rityyari.co.id/ghoul.php and mirror links to Zone-Xsec (https://zone-xsec.com/archive/attacker/boss-ranzen), HaxorID (https://haxor.id/archive/attacker/Boss-Ranzen), and Zone-H (https://www.zone-h.org/archive/notifier=Boss%20Ranzen).
        ...
        ![Boss Ranzen-4.png](/assets/img/osint/boss-ranzen/Boss_Ranzen-4.png)
    ...
    - Another post on December 27, 2023, included URLs ending in /readme.html (e.g., http://centralgroup.id/readme.html) and similar mirror links, indicating defaced pages.
        ...
        ![Boss Ranzen-8.1.png](/assets/img/osint/boss-ranzen/Boss_Ranzen-8.1.png)
...
- **Action**: Conducted a search using the query "Boss Ranzen" filetype: txt.
    ...
    ![Boss Ranzen-3.2.png](/assets/img/osint/boss-ranzen/Boss_Ranzen-3.2.png)
...
- **Findings**:
    - Likely uncovered text files or documents containing defacement messages or hacking logs related to Boss Ranzen’s activities.
        ...
        ![Boss Ranzen-10.png](/assets/img/osint/boss-ranzen/Boss_Ranzen-10.png)
...
- **Action**: Searched for the alias "Renzaskyi," identified from the Facebook posts.
    ...
    ![Boss Ranzen-10.2.png](/assets/img/osint/boss-ranzen/Boss_Ranzen-10.2.png)
    
    ![Boss Ranzen-3.png](/assets/img/osint/boss-ranzen/Boss_Ranzen-3.png)
    
- **Findings**:
    - Located a GeoNode profile for "Renzaskyi" at https://mapas.mnstate.edu/geonode/people/profile/Renzaskyi/?limit=50&offset=0.
        
        ![Boss Ranzen-5.png](/assets/img/osint/boss-ranzen/Boss_Ranzen-5.png)
...
- **Details**:
    ...
    ![Boss Ranzen-9.png](/assets/img/osint/boss-ranzen/Boss_Ranzen-9.png)
...
- **Findings**:
    ...
    ![Boss Ranzen-6.png](/assets/img/osint/boss-ranzen/Boss_Ranzen-6.png)
    
    ![Boss Ranzen-7.png](/assets/img/osint/boss-ranzen/Boss_Ranzen-7.png)
...
- **Social Media Analysis**:
    ...
    - A post on March 31, 2024, detailed a hacking process involving Elfinder, symlinking, and penetrating a main domain (veracruzmuniciplio.gob.mx/dj0at.php), with a mirror link to Boss Ranzen’s archive on Zone-Xsec.
        ...
        ![Boss Ranzen-8.png](/assets/img/osint/boss-ranzen/Boss_Ranzen-8.png)
...
![GH05T666.png](/assets/img/osint/boss-ranzen/GH05T666.png)

![GH05T666-1.png](/assets/img/osint/boss-ranzen/GH05T666-1.png)

![Boss Ranzen-7.2.png](/assets/img/osint/boss-ranzen/Boss_Ranzen-7.2.png)
