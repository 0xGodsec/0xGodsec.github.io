...
difficulty: Hard
image: /assets/img/osint/cambodia-thailand-conflict/Preah-vihear_temple.webp
---
...
![Untitled design (1)](/assets/img/osint/cambodia-thailand-conflict/Untitled_design_1.png)
...
[OSINT Report: Threat Actor Profile - H3C4KEDZ](https://app.notion.com/p/OSINT-Report-Threat-Actor-Profile-H3C4KEDZ-24e2941b704e801a96bdfe14a921feb4?pvs=21)

[OSINT Report: Threat Actor Profile - H3C4KEDZ](https://app.notion.com/p/OSINT-Report-Threat-Actor-Profile-H3C4KEDZ-3912941b704e810499aec3ad11719a98?pvs=21)

[OSINT Report: Threat Actor Profile - KOLzSec Cyber Activities](https://app.notion.com/p/OSINT-Report-Threat-Actor-Profile-KOLzSec-Cyber-Activities-24e2941b704e804f9c6dc17a0b33ae29?pvs=21)

[OSINT Report: Threat Actor Profile - AnonSecKh / BL4CK CYB3R](https://app.notion.com/p/OSINT-Report-Threat-Actor-Profile-AnonSecKh-BL4CK-CYB3R-24e2941b704e808ea9c6f651f5c86887?pvs=21)
...
![Untitled design](/assets/img/osint/cambodia-thailand-conflict/Untitled_design.png)
...
- **X Accounts**:
    ...
    ![image](/assets/img/osint/cambodia-thailand-conflict/image.png)
    
    - `@h3*****zsec` (1 follower).
    
    ![image](/assets/img/osint/cambodia-thailand-conflict/image-1.png)
    
    - `@h******d` (bio: "WE ARE H3C4KEDZ," 7 followers).
    
    ![image](/assets/img/osint/cambodia-thailand-conflict/image-2.png)
...
![image](/assets/img/osint/cambodia-thailand-conflict/image-3.png)

![image](/assets/img/osint/cambodia-thailand-conflict/image-4.png)

- **GitHub**: `github.com/H3*****` hosts repositories with DDoS tools (Ddos, DDOSV1, GhostDDOSV2), dirsearch (directory enumeration), and SQL-INJECTION scripts, indicating technical capabilities.
    
    ![Github 1](/assets/img/osint/cambodia-thailand-conflict/afa7a562-d60c-4451-b2c6-380abc40c30b.png)
    

![Github 2](/assets/img/osint/cambodia-thailand-conflict/610d6e7c-3014-492a-a392-51287d3fa697.png)
...
![image](/assets/img/osint/cambodia-thailand-conflict/fb4268bc-5e5b-44d1-b69d-12f387e5472f.png)
...
- **Ongoing Operations**:
    ...
    ![image](/assets/img/osint/cambodia-thailand-conflict/image-5.png)
...
- **Historical Context**:
    ...
    ![image](/assets/img/osint/cambodia-thailand-conflict/image-6.png)
    

![image](/assets/img/osint/cambodia-thailand-conflict/image-7.png)
...
- **URLs**: `github.com/H3*****`, `s*******ing.bop.police.go.th`, `~~awgateasean.doae.go.th~~`, `~~h3c***dz.com~~`.
- **Emails**: `~~non****family@gmail.com~~` (from stealth mole data).
...
2. **Data Leaks and Exposure**:
    ...
    ![image](/assets/img/osint/cambodia-thailand-conflict/image-9.png)
    
3. **Defacement and Propaganda**:
    - Website defacements and propaganda dissemination are key tactics, with messages urging supporters to share attack claims (e.g., `https://t.me/addlist/ig*********jk9`). Hashtags like `#OpThailand2025` highlight their political motivation.

## Compromised Systems and Data

![image](/assets/img/osint/cambodia-thailand-conflict/image-10.png)

![image](/assets/img/osint/cambodia-thailand-conflict/image-11.png)
...
- **Email and Contact Lists**:
    - The `658a**************************************4dbabf76c71656.txt`  file contains a large dataset of email addresses and IPs, likely harvested through phishing or system compromises, supporting their reconnaissance efforts.
    
    ![Email](/assets/img/osint/cambodia-thailand-conflict/Email.png)
...
2. **Data Exfiltration**: 
    ...
    ![image](/assets/img/osint/cambodia-thailand-conflict/image-12.png)
...
3. **Social Media and Telegram Coordination**:
    ...
    ![image](/assets/img/osint/cambodia-thailand-conflict/image-13.png)
...
- **Stealth Mole Analysis**:
    - Network maps show connections to Telegram messages, media, and external links (e.g., `https://twitter.com/****2`), indicating a decentralized yet interconnected structure.
    
    ![image](/assets/img/osint/cambodia-thailand-conflict/image-14.png)
...
1. **DDoS Attacks**:
    ...
    ![image](/assets/img/osint/cambodia-thailand-conflict/image-15.png)
...
2. **Data Leaks**:
    ...
    ![image](/assets/img/osint/cambodia-thailand-conflict/image-16.png)
...
- NXBBSEC claims to have compromised various systems, with evidence of targeting Thai governmental and institutional entities. Specific instances include the leakage of login credentials for the Police Road Safety - Thailand system on June 26, 2025, suggesting unauthorized access. Additionally, a document leak from `k*s.p**g-obec.go.th` on August 6, 2025, indicates potential exploitation of educational or governmental systems in Thailand.
    
    ![image](/assets/img/osint/cambodia-thailand-conflict/image-17.png)
...
![image](/assets/img/osint/cambodia-thailand-conflict/image-18.png)
...
- **Cambodia Targets**:
    ...
    ![image](/assets/img/osint/cambodia-thailand-conflict/image-19.png)
...
- **Leadership**: A member named SAZZ claims to be the true owner and operator, as per an announcement on August 13, 2025.
    ...
    ![X](/assets/img/osint/cambodia-thailand-conflict/X.png)
...
![Screenshot 2025-08-13 223945](/assets/img/osint/cambodia-thailand-conflict/Screenshot_2025-08-13_223945.png)

![X 2](/assets/img/osint/cambodia-thailand-conflict/X_2.png)
...
![image](/assets/img/osint/cambodia-thailand-conflict/image-21.png)

## Key Findings

### Types of Attacks

![image](/assets/img/osint/cambodia-thailand-conflict/image-22.png)
...
![image](/assets/img/osint/cambodia-thailand-conflict/image-23.png)
...
![image](/assets/img/osint/cambodia-thailand-conflict/image-24.png)
...
![image](/assets/img/osint/cambodia-thailand-conflict/image-25.png)
...
![image](/assets/img/osint/cambodia-thailand-conflict/image-27.png)
...
- **Social Media Presence**: Active on X under @KOLzSec
    ...
    ![X](/assets/img/osint/cambodia-thailand-conflict/X-1.png)
...
1. DDOS Attack:
    ...
    ![image](/assets/img/osint/cambodia-thailand-conflict/image-28.png)
    
    - Zone-XSEC records 11 total defacements, including homepages.
    
    ![zone-xsec](/assets/img/osint/cambodia-thailand-conflict/zone-xsec.png)
...
2. **Data Breaches and Credential Leaks**:
    ...
    ![image](/assets/img/osint/cambodia-thailand-conflict/image-29.png)
    
3. **Social Engineering**:
    - Targeted login pages (e.g., Google, GitHub) and Android URLs suggest phishing campaigns.
        
        ![image](/assets/img/osint/cambodia-thailand-conflict/image-30.png)
        
        ![Chatlog profile](/assets/img/osint/cambodia-thailand-conflict/Chatlog_profile.png)
...
- **For Researchers**: Map ANONSEC-CAMBODIA and allied groups.
    ...
    [OSINT Report: Threat Actor Profile - NXBBSEC](https://app.notion.com/p/OSINT-Report-Threat-Actor-Profile-NXBBSEC-24e2941b704e80cd866ee7355c58093f?pvs=21)
    
    [OSINT Report: Threat Actor Profile - NRSTSEC ](https://app.notion.com/p/OSINT-Report-Threat-Actor-Profile-NRSTSEC-24e2941b704e809daabef8ad6b57ceba?pvs=21)
...
![image](/assets/img/osint/cambodia-thailand-conflict/image-31.png)

![image](/assets/img/osint/cambodia-thailand-conflict/image-32.png)
...
![image](/assets/img/osint/cambodia-thailand-conflict/image-33.png)
